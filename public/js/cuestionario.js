    ...
    const buscarPeliculas = page => {
        fetch(`${url}&page=${page}`)
            ...
            peliculaItem.addEventListener('click', function () {
                ...
                // Crear contenedor de detalles si no existe uno
                if (!contenedorDetallesActual) {
                    contenedorDetallesActual = document.createElement('div')
                    contenedorDetallesActual.classList.add('detalles')
                    detalles.appendChild(contenedorDetallesActual)
                }

                // Agregar elementos al contenedor de detalles
                contenedorDetallesActual.innerHTML = ''
                contenedorDetallesActual.appendChild(peliculaTitulo)
                contenedorDetallesActual.appendChild(p)
                contenedorDetallesActual.appendChild(votoTexto)
                contenedorDetallesActual.appendChild(verTrailerBtn)
